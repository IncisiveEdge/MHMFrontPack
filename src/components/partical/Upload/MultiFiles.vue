...
<template>
  <div>
    ...
    <button type="button" id="j_single_upload_img_btn">单图上传</button>
    <ul id="single_upload_img_wrap"></ul>
...
// 实例化编辑器，这里注意配置项隐藏编辑器并禁用默认的基础功能。
      ...
      document.getElementById('j_single_upload_img_btn').onclick = function () {
//        var dialog = uploadEditor.getDialog("simpleupload");
//        dialog.title = '单图上传';
//        dialog.render();
//        dialog.open();
